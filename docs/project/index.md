...
- 2026-05-31 — `identidade-acesso` avança do ciclo `repositorio` para `deploy` em triagem no branch `codex/repositorio-identidade-acesso-2026-05-31`, com raiz física e scaffolds mínimos; PR ainda pendente nesta evidência temporária.
