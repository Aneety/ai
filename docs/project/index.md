...
| `identidade-acesso` | Ricardo Malnati | alta | `publicacao` | `triagem` | [identidade-acesso](./identidade-acesso.md) | [`Cloudflare deploy gate` dry-run #26736094412](https://github.com/Aneety/ai/actions/runs/26736094412) validou `identidade-acesso` no SHA [`2d8c40b`](https://github.com/Aneety/ai/commit/2d8c40bc6fc4a67807b4299c09752ddf80e36639) sem segredo versionado e com runtime Workers compatível. | — |
