...
| `tenant-white-label` | Ricardo Malnati | alta | `backend` | `triagem` | [tenant-white-label](./tenant-white-label.md) | [`Cloudflare D1 gate` #26850571410](https://github.com/Aneety/ai/actions/runs/26850571410) validou migration, seed, fixture e rollback em banco efêmero D1; `db-tenant-white-label/d1-validation-evidence.json` registrou o SHA [61d1b39](https://github.com/Aneety/ai/commit/61d1b39fa4fb9cdd51644eab65f45a1609a08c6e). | — |
