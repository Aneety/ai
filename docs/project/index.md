...
| `tenant-white-label` | Ricardo Malnati | alta | `backend` | `triagem` | [tenant-white-label](./tenant-white-label.md) | [`Cloudflare D1 gate` #26850845013](https://github.com/Aneety/ai/actions/runs/26850845013) validou migration, seed, fixture e rollback em banco efêmero D1; `db-tenant-white-label/d1-validation-evidence.json` registrou o SHA [42550e2](https://github.com/Aneety/ai/commit/42550e2807629a3807f3de90bf519ec6108db0a9). | — |
