...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `gateway-borda` | Ricardo Malnati | alta | `deploy` | `pronto` | [gateway-borda](./gateway-borda.md) | [PR #14](https://github.com/Aneety/ai/pull/14) valida raiz canônica `aneety-platform/apps/gateway-borda/` com checks remotos verdes e merge em `main`. | — |
