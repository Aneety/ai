...
| `publicacao` | `concluido` | alta | `processo` | [`Cloudflare deploy gate` deploy #26741121849](https://github.com/Aneety/ai/actions/runs/26741121849) publicou a URL real `https://worker-tenant-white-label.ricardomalnati.workers.dev`, [`Cloudflare deploy gate` smoke #26741152917](https://github.com/Aneety/ai/actions/runs/26741152917) validou o endpoint público e `worker-tenant-white-label/publication-evidence.json` registrou o SHA [2e40958](https://github.com/Aneety/ai/commit/2e4095834b5a71cfb3a75708b22869b3933b6611). | — | Executar `banco` com evidência objetiva do primeiro contrato persistido após a URL pública validada. |
