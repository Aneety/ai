# mfe-catalogo-operacional

## Objetivo

Reservar o microfrontend operacional da responsabilidade `catalogo-operacional` para seleção de produto/serviço, categorias, atributos, raio/capacidade e requisitos de evidência.
