# mfe-producao-execucao

## Objetivo

Reservar o microfrontend operacional da responsabilidade `producao-execucao` para ordem de execução, histórico, atraso, conclusão de etapa e anexos do caso.
