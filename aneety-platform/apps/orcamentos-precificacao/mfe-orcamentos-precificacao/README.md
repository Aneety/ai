# mfe-orcamentos-precificacao

## Objetivo

Reservar o microfrontend operacional da responsabilidade `orcamentos-precificacao` para solicitação de orçamento, comparação de cotação, validade, urgência e decisão.
