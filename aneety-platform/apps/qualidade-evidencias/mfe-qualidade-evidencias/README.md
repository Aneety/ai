# mfe-qualidade-evidencias

## Objetivo

Reservar o microfrontend operacional da responsabilidade `qualidade-evidencias` para registro de evidências, aprovação de qualidade, checklist e motivo de correção.
