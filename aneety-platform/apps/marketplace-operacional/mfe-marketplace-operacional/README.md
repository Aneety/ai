# mfe-marketplace-operacional

## Objetivo

Reservar o microfrontend operacional da responsabilidade `marketplace-operacional` para comparativo de fornecedores, perfil produtivo, painel de demandas e seleção operacional.
