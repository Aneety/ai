# mfe-suporte-excecoes

## Objetivo

Reservar o microfrontend operacional da responsabilidade `suporte-excecoes` para abertura de disputa, motivo, evidências, remédio e mensagens vinculadas ao pedido.
