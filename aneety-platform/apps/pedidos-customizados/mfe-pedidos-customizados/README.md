...
Reservar o microfrontend operacional da responsabilidade `pedidos-customizados` para detalhe do pedido, solicitação de orçamento, confirmação de envio, recebimento e estados de acompanhamento.
