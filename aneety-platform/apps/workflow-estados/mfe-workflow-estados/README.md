# mfe-workflow-estados

## Objetivo

Reservar o microfrontend operacional da responsabilidade `workflow-estados` para transições permitidas, bloqueios, atraso, conflito e próxima ação por papel.
